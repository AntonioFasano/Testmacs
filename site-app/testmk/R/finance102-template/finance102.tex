% This is the scratch of a template to be used by mix.R for random question generation
...
% mix.r wants \printanswers command, do not remove/comment it.
% NOTE:
% "grade.R" replaces the content of the first \fbox{...}, with:
%     student details found in answer files and grades
% Grades are obtained matching answer files with RData solution file.
...
\runningheadrule
\firstpageheader{\textbf{Finance102}}{}{Page \thepage\ of \numpages}
\runningheader{\textbf{Finance102}}{}{Page \thepage\ of \numpages}
...
{Full name and signature:\enspace\hrulefill\quad\hrulefill

Date of birth (day/month/year): \hrulefill\
Today is (day/month/year): \hrulefill 

Official email address:  \enspace\fillin\fillin  
}}
